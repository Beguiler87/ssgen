...
def main():
	...
	dest_dir_path = "docs"
	generate_pages_recursive(dir_path_content, template_path, dest_dir_path, basepath=basepath)
	...
	for root, dirs, files in os.walk(dir_path_content):
		for file in files:
			if file.endswith(".md"):
				...
				# Generate the page
				generate_page(markdown_path, template_path, destination_path, basepath=basepath)
